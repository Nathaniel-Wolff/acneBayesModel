...
I_t \\
S_t
\end{pmatrix}, u_{t} = \begin{pmatrix}days_{antibiotics}\\cream_{used}\\T(tstd)\end{pmatrix}\\\\\\v_{t} = F_{\theta}(v_{t-1}, u_{t}\mid \theta) + w_{t}, \hspace{1cm}\ w_{t}\sim N(0,R)\\\\\
%Severity\,State\,As\,A\,Function\,of\,v_{t}: 
x_{t}= g(v_{t}) + \eta_{t}, \hspace{2.9cm}\eta_{t}\sim N(0,R)$$
