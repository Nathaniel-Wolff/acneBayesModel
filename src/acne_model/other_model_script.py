...
model_params, treatment_params = process_data_and_build_HBM(these_frames, model_priors_and_config_handle=json_name,
...
#dump into JSON
with open("model_params.json", "w") as mp:
    json.dump(model_params, mp, indent=3)

with open("treatment_params.json", "w") as tp:
     json.dump(treatment_params, tp, indent = 3)
